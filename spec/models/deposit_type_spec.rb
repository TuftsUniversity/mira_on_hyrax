...
describe DepositType do
  ...
  it 'requires a display_name' do
    expect(FactoryBot.build(:deposit_type, display_name: nil)).not_to be_valid
  end

  it 'requires a license_name' do
    expect(FactoryBot.build(:deposit_type, license_name: nil)).not_to be_valid
  end

  it 'requires a deposit_view' do
    expect(FactoryBot.build(:deposit_type, deposit_view: nil)).not_to be_valid
  end
  ...
  it 'must have unique display names' do
    ...
    dup_type =
      FactoryBot.build(:deposit_type, display_name: deposit_type.display_name)
  ...
  it 'must have a deposit_view that points to a vaild partial' do
    invalid_partial_type =
      FactoryBot.build(:deposit_type, deposit_view: 'invalid_view_partial')
  ...
  it 'sanitizes deposit_agreement input' do
    ...
    dt = FactoryBot.create(:deposit_type, deposit_agreement: bad_text)
